...
<?php
require "koneksi.php";
require "ex_data_digmar.php";
require "hapus_digital_market.php";
?>
...
<head>
    ...
    <title>Admin | Data Peserta Kursus Digital Marketing</title>
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" aria-current="page" href="bukti_bayar_kursus_digital_market">Bukti Pembayaran</a>
                        </li>
                        <li class="nav-item mx-3">
    ...
    <div class="mx-auto">
        <form action="data_peserta_digital_market" method="get">
            <center>
                <p class="fs-3">DATA PESERTA KURSUS DIGITAL MARKET</p>
            </center>
            <div class="mb-3">
                <center>
                    ...
                    <a href="data_peserta_digital_market"><button type="button" class="btn btn-danger btn-sm">Batal</button></a>
        ...
        <form action="data_peserta_digital_market" method="get">
            <div class="mb-3">
                <center>
                    ...
                    <a href="data_peserta_digital_market"><button type="button" class="btn btn-danger btn-sm">Batal</button></a>
                    <a href="to_excel_daftar_dig_mar" class="btn btn-sm btn-success">Cetak Seluruh Data</a>
                </center>
            </div>
        </form>
        ...
        <div class="container">
            <div class="table-responsive">
                <div class="table-wrapper">
                    <table class="table table-sm table-bordered">
                        ...
                        if (isset($_GET['cari'])) {
                            $cari = $_GET['cari'];
                            $tampil = mysqli_query($conn, "select * from daftar_digital_market where nik like '%" . $cari . "%' or nama like '%" . $cari . "%' or telepon like '%" . $cari . "%' or paket like '%" . $cari . "%' or pilih_bayar like '%" . $cari . "%' or kecamatan like '%" . $cari . "%' or jk like '%" . $cari . "%'");
                        } elseif (isset($_GET['tglawal'])) {
                            $tglawal = $_GET['tglawal'];
                            $tglakhir = $_GET['tglakhir'];
                            $tampil = mysqli_query($conn, "select * from daftar_digital_market where tanggal_upload between '" . $tglawal . "' and '" . $tglakhir . "' order by id asc");
                        } else {
                            $tampil = mysqli_query($conn, "select * from daftar_digital_market");
                        }
                        ...
                        ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a class="btn btn-warning btn-sm" href="form_edit_mengemudi?id=<?php echo $data['id'] ?>">Edit</a>
                                            <!-- Button trigger modal -->
            ...
            <center>
                ...
                <?php
                $laki_laki = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM daftar_digital_market where jk='Laki-laki'"));
                $perempuan = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM daftar_digital_market where jk='Perempuan'"));
                $total = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM daftar_digital_market where id"));
                ?>
