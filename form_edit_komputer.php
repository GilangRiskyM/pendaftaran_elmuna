<?php
include 'koneksi.php';
$data_edit = mysqli_query($conn, "SELECT * FROM daftar_komputer WHERE id = '" . $_GET['id'] . "'");
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" href="data_peserta_komputer">Kembali</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        <span class="input-group-text" style="width: 135px; justify-content:center; height: 520px;">
                            <center>Paket</center>
                        </span>
                        <span>
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET OFFICE WORD" <?php if (in_array("PAKET OFFICE WORD", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET OFFICE WORD</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET OFFICE EXCEL" <?php if (in_array("PAKET OFFICE EXCEL", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET OFFICE EXCEL</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET OFFICE POWER POINT" <?php if (in_array("PAKET OFFICE POWER POINT", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET OFFICE POWER POINT</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET OFFICE KOMPLIT" <?php if (in_array("PAKET OFFICE KOMPLIT", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET OFFICE KOMPLIT</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET SPECIAL POWER POINT PRESENTASI" <?php if (in_array("PAKET SPECIAL POWER POINT PRESENTASI", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET SPECIAL POWER POINT PRESENTASI</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET SPECIAL POWER POINT BISNIS" <?php if (in_array("PAKET SPECIAL POWER POINT BISNIS", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET SPECIAL POWER POINT BISNIS</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET SPECIAL POWER POINT VIDEO ANIMASI" <?php if (in_array("PAKET SPECIAL POWER POINT VIDEO ANIMASI", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET SPECIAL POWER POINT VIDEO ANIMASI</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="DESAIN GRAFIS COREL DRAW" <?php if (in_array("DESAIN GRAFIS COREL DRAW", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="DESAIN GRAFIS PHOTOSHOP" <?php if (in_array("DESAIN GRAFIS PHOTOSHOP", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="DESAIN GRAFIS CANVA" <?php if (in_array("DESAIN GRAFIS CANVA", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET DESAIN GRAFIS COREL DRAW & PHOTOSHOP" <?php if (in_array("PAKET DESAIN GRAFIS COREL DRAW & PHOTOSHOP", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET DESAIN GRAFIS COREL DRAW & PHOTOSHOP</label>
                                </div>
                            </div>

                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="EDITING VIDEO FILMORA" <?php if (in_array("EDITING VIDEO FILMORA", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="FOTOGRAFI" <?php if (in_array("FOTOGRAFI", $datapaket)) echo "checked"; ?>>
