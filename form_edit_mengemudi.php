...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" href="data_peserta_mengemudi">Kembali</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="input-group mb-3">
                        <span><label class="input-group-text" style="width: 135px; height: 200px;">
                                <center>Paket</center>
                            </label>
                        </span>
                        ...
                        <span>
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET MANUAL 1 (MELANCARKAN)" <?php if (in_array("PAKET MANUAL 1 (MELANCARKAN)", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET MANUAL 2 (PEMULA)" <?php if (in_array("PAKET MANUAL 2 (PEMULA)", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET MANUAL 3 (MAHIR)" <?php if (in_array("PAKET MANUAL 3 (MAHIR)", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET MATIC 1 (PEMULA)" <?php if (in_array("PAKET MATIC 1 (PEMULA)", $datapaket)) echo "checked"; ?>>
                            ...
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET MATIC 2 (MAHIR)" <?php if (in_array("PAKET MATIC 2 (MAHIR)", $datapaket)) echo "checked"; ?>>
    ...
    if ($update) {
        echo "
                <script>
                    alert('Data Telah Di UPDATE!');window.location='data_peserta_mengemudi'
                </script>
                ";
    }
    ?>
