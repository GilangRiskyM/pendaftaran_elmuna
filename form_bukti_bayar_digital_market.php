...
<head>
    ...
    <title>Elmuna | Bukti Pembayaran Kursus Digital Marketing</title>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <center>
                    <h3 class="text-light">Form Bukti Pembayaran Kursus Digital Marketing</h3>
                </center>
            </div>
            <div class="card-body">
                <form action="fungsi_bukti_bayar_digital_market" method="post" enctype="multipart/form-data">
