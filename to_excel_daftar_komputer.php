...
<body>
    ...
    header("Content-Disposition: attachment; filename=Data Peserta Komputer.xls");
    ?>
    ...
    <table border="1">
        ...
        if (isset($_GET['kata_cari'])) {
            ...
            $query = "SELECT * FROM daftar_komputer WHERE nik LIKE '%" . $kata_cari . "%' OR nama LIKE '%" . $kata_cari . "%' OR paket LIKE '%" . $kata_cari . "%' ORDER BY id ASC";
        } else {
            $query = "SELECT * FROM daftar_komputer ORDER BY id ASC";
        }
