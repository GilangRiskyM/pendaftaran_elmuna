...
<?php
require "koneksi.php";
require "ex_data_komputer.php";
require "hapus_komputer.php";
?>
...
<head>
    ...
    <title>Admin | Data Peserta Kursus Komputer</title>
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" aria-current="page" href="bukti_bayar_kursus_komputer">Bukti Pembayaran</a>
                        </li>
                        <li class="nav-item mx-3">
    ...
    <div class="mx-auto">
        <form action="data_peserta_komputer" method="get">
            <center>
                <p class="fs-3">DATA PESERTA KURSUS KOMPUTER</p>
            </center>
            <div class="mb-3">
                <center>
                    ...
                    <a href="data_peserta_komputer"><button type="button" class="btn btn-danger btn-sm">Batal</button></a>
        ...
        <form action="data_peserta_komputer" method="get">
            <div class="mb-3">
                <center>
                    ...
                    <a href="data_peserta_komputer"><button type="button" class="btn btn-danger btn-sm">Batal</button></a>
                    <a href="to_excel_daftar_komputer" class="btn btn-sm btn-success">Cetak Seluruh Data</a>
                </center>
            </div>
        </form>
        <center>
        ...
        <div class="container">
            <div class="table-responsive">
                <div class="table-wrapper">
                    <table class="table table-sm table-bordered">
                        ...
                        if (isset($_GET['cari'])) {
                            $cari = $_GET['cari'];
                            $tampil = mysqli_query($conn, "select * from daftar_komputer where nik like '%" . $cari . "%' or nama like '%" . $cari . "%' or telepon like '%" . $cari . "%' or paket like '%" . $cari . "%' or pilih_bayar like '%" . $cari . "%' or kecamatan like '%" . $cari . "%' or jk like '%" . $cari . "%'");
                        } elseif (isset($_GET['tglawal'])) {
                            $tglawal = $_GET['tglawal'];
                            $tglakhir = $_GET['tglakhir'];
                            $tampil = mysqli_query($conn, "select * from daftar_komputer where tanggal_upload between '" . $tglawal . "' and '" . $tglakhir . "' order by id asc");
                        } else {
                            $tampil = mysqli_query($conn, "select * from daftar_komputer");
                        }
            ...
            <center>
                ...
                <?php
                $laki_laki = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM daftar_komputer where jk='Laki-laki'"));
                $perempuan = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM daftar_komputer where jk='Perempuan'"));
                $total = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM daftar_komputer where id"));
                ?>
