...
<head>
    ...
    <title>Elmuna | Pendaftaran Kursus Bahasa Inggris</title>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <center>
                    <h3 class="text-light">Form Pendaftaran Kursus Bahasa Inggris</h3>
                </center>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <center><a href="form_bukti_bayar_bahasa_inggris"><button type="button" class="btn btn-info" style="margin-top: 8px;">Kirim Bukti Pembayaran</button></a></center>
                </form>
            </div>
        </div>
    </div>
...
if (isset($_POST['kirim'])) {
    ...
    $simpan = "INSERT INTO daftar_bahasa_inggris(nik, nama, alamat, tempat_lahir, tanggal_lahir, jk, nama_ayah, nama_ibu, telepon, email, kecamatan, paket, pilih_bayar,tanggal_upload) VALUES ('.$nik.','$nama','$alamat','$tempat_lahir','$tanggal_lahir','$jk','$nama_ayah','$nama_ibu','.$telepon.','$email','$kecamatan','$paket','$pilih_bayar',now())";
    $result = mysqli_query($conn, $simpan);

    if ($result) {
        echo "
        <script>
            alert('Data Telah Dikirim!');window.location='daftar_bahasa_inggris.php'
        </script>
        ";
    }
}
