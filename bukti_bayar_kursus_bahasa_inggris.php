...
<?php
include 'koneksi.php';
require "hapus_bukti_bayar_bahasa_inggris.php";
...
<head>
    ...
    <title>Admin| Bukti Bayar Kursus Bahasa Inggris</title>
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" aria-current="page" href="data_peserta_bahasa_inggris">Data Peserta</a>
                        </li>
                        <li class="nav-item mx-3">
    ...
    <div class="mx-auto">
        <form action="" method="">
            <center>
                <p class="fs-3">Data Bukti Bayar Kursus Bahasa Inggris</p>
            </center>
            <div class="mb-3">
                <center>
                    ...
                    <a href="bukti_bayar_kursus_mengemudi"><button type="button" class="btn btn-danger btn-sm">Batal</button></a>
                </center>
            </div>
        </form>
                ...
                <div class="table-wrapper">
                    <table class="table table-sm table-bordered">
                        ...
                        if (isset($_GET['kata_cari'])) {
                            ...
                            $query = "SELECT * FROM bukti_bayar_kursus_bahasa_inggris WHERE nama LIKE '%" . $kata_cari . "%' OR nik LIKE '%" . $kata_cari . "%' OR paket LIKE '%" . $kata_cari . "%' ORDER BY id ASC";
                        } else {
                            $query = "SELECT * FROM bukti_bayar_kursus_bahasa_inggris ORDER BY id ASC";
                        }
                        ...
                        ?>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td scope="row"><?= "<img src='bukti_bayar_bahasa_inggris/" . $hasil['foto'] . "' width='35%' height='35%'>" ?></td>
