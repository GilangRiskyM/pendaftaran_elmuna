...
<body>
    ...
    header("Content-Disposition: attachment; filename=Data Peserta Bahasa Inggris.xls");
    ?>
    ...
    <table border="1">
        ...
        if (isset($_GET['kata_cari'])) {
            ...
            $query = "SELECT * FROM daftar_bahasa_inggris WHERE nik LIKE '%" . $kata_cari . "%' OR nama LIKE '%" . $kata_cari . "%' OR paket LIKE '%" . $kata_cari . "%' ORDER BY id ASC";
        } else {
            $query = "SELECT * FROM daftar_bahasa_inggris ORDER BY id ASC";
        }
