...
<head>
    ...
    <title>Elmuna | Bukti Pembayaran Kursus Komputer</title>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <center>
                    <h3 class="text-light">Form Bukti Pembayaran Kursus Komputer</h3>
                </center>
            </div>
            <div class="card-body">
                <form action="fungsi_bukti_bayar_komputer" method="post" enctype="multipart/form-data">
