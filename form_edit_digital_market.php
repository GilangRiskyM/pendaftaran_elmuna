<?php
include 'koneksi.php';
$data_edit = mysqli_query($conn, "SELECT * FROM daftar_digital_market WHERE id = '" . $_GET['id'] . "'");
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" href="data_peserta_digital_market">Kembali</a>
                        </li>
                    </ul>
                </div>
            </div>
                        ...
                        <span>
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET PEMULA" <?php if (in_array("PAKET PEMULA", $datapaket)) echo "checked"; ?>>
                                    <label class="form-check-label" for="inlineCheckbox1">PAKET PEMULA</label>
                                </div>
                            </div>
                            <div class="input-group-text ms-1">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="paket[]" value="PAKET MAHIR" <?php if (in_array("PAKET MAHIR", $datapaket)) echo "checked"; ?>>
