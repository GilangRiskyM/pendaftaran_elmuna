...
<body>
    ...
    header("Content-Disposition: attachment; filename=Data Peserta Digital Marketing.xls");
    ?>
    ...
    <table border="1">
        ...
        if (isset($_GET['kata_cari'])) {
            ...
            $query = "SELECT * FROM daftar_digital_market WHERE nik LIKE '%" . $kata_cari . "%' OR nama LIKE '%" . $kata_cari . "%' OR paket LIKE '%" . $kata_cari . "%' ORDER BY id ASC";
        } else {
            $query = "SELECT * FROM daftar_digital_market ORDER BY id ASC";
        }
