...
$path = "bukti_bayar_bahasa_inggris/" . $foto;
...
if ($tipe_file == "image/jpeg" || $tipe_file == "image/png" || $tipe_file == "image/jpg") { // Cek apakah tipe file yang diupload adalah JPG / JPEG / PNG
  ...
  if ($ukuran_file <= 10000000) { // Cek apakah ukuran file yang diupload kurang dari sama dengan 10MB
    ...
    if (move_uploaded_file($tmp_file, $path)) { // Cek apakah gambar berhasil diupload atau tidak
      ...
      $query = "INSERT INTO bukti_bayar_kursus_bahasa_inggris(nik, nama, paket, harga, foto, keterangan) VALUES ('$nik','$nama','$paket','$harga','$foto','$keterangan')";
      ...
      if ($sql) { // Cek jika proses simpan ke database sukses atau tidak
        ...
        echo "
        <script>
            alert('Data Telah Dikirim!');window.location='form_bukti_bayar_bahasa_inggris'
        </script>
        ";
      } else {
        // Jika Gagal, Lakukan :
        echo "Maaf, Terjadi kesalahan saat mencoba untuk menyimpan data ke database.";
        echo "<br><a href='form_bukti_bayar_bahasa_inggris'>Kembali Ke Form</a>";
      }
    } else {
