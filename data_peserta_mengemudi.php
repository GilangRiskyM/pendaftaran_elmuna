...
<?php
require "koneksi.php";
require "ex_data_mengemudi.php";
require "hapus_mengemudi.php";
?>
...
<head>
    ...
    <title>Admin | Data Peserta Kursus Mengemudi</title>
...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
                        <li class="nav-item mx-3">
                            <a class="nav-link active" aria-current="page" href="bukti_bayar_kursus_mengemudi">Bukti Pembayaran</a>
                        </li>
                        <li class="nav-item mx-3">
    ...
    <div class="mx-auto">
        <form action="data_peserta_mengemudi" method="get">
            <center>
                <p class="fs-3">DATA PESERTA KURSUS MENGEMUDI</p>
            </center>
            <div class="mb-3">
                <center>
                    ...
                    <a href="data_peserta_mengemudi"><button type="button" class="btn btn-danger btn-sm">Batal</button></a>
        ...
        <form action="data_peserta_mengemudi" method="get">
            <div class="mb-3">
                <center>
                    ...
                    <a href="data_peserta_mengemudi"><button type="button" class="btn btn-danger btn-sm">Batal</button></a>
                    <a href="to_excel_daftar_mengemudi" class="btn btn-sm btn-success">Cetak Seluruh Data</a>
                </center>
            </div>
        </form>
        ...
        <div class="container">
            <div class="table-responsive">
                <div class="table-wrapper">
                    <table class="table table-sm table-bordered">
                        ...
                        if (isset($_GET['cari'])) {
                            $cari = $_GET['cari'];
                            $tampil = mysqli_query($conn, "select * from daftar_mengemudi where nik like '%" . $cari . "%' or nama like '%" . $cari . "%' or telepon like '%" . $cari . "%' or paket like '%" . $cari . "%' or pilih_bayar like '%" . $cari . "%' or kecamatan like '%" . $cari . "%' or jk like '%" . $cari . "%'");
                        } elseif (isset($_GET['tglawal'])) {
                            $tglawal = $_GET['tglawal'];
                            $tglakhir = $_GET['tglakhir'];
                            $tampil = mysqli_query($conn, "select * from daftar_mengemudi where tanggal_upload between '" . $tglawal . "' and '" . $tglakhir . "' order by id asc");
                        } else {
                            $tampil = mysqli_query($conn, "select * from daftar_mengemudi");
                        }
            ...
            <center>
                ...
                $total = mysqli_num_rows(mysqli_query($conn, "SELECT * FROM daftar_mengemudi where id"));
                ?>
