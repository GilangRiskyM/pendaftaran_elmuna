...
<head>
    ...
    <title>Elmuna | Pendaftaran Kursus Digital Marketing</title>
    ...
    <div class="container">
        <div class="card">
            <div class="card-header">
                <center>
                    <h3 class="text-light">Form Pendaftaran Kursus Digital Marketing</h3>
                </center>
            </div>
            <div class="card-body">
                <form action="" method="post">
                    ...
                    <div class="input-group-text mb-1">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox1" name="paket[]" value="PAKET PEMULA">
                            <label class="form-check-label" for="inlineCheckbox1">PAKET PEMULA</label>
                        </div>
                    </div>
                    <div class="input-group-text mb-3">
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox2" name="paket[]" value="PAKET MAHIR">
                            <label class="form-check-label" for="inlineCheckbox2">PAKET MAHIR</label>
                        </div>
                    </div>
                    ...
                    <center><a href="form_bukti_bayar_digital_market"><button type="button" class="btn btn-info" style="margin-top: 8px;">Kirim Bukti Pembayaran</button></a></center>
                </form>
            </div>
        </div>
    </div>
...
if (isset($_POST['kirim'])) {
    ...
    $simpan = "INSERT INTO daftar_digital_market(nik, nama, alamat, tempat_lahir, tanggal_lahir, jk, nama_ayah, nama_ibu, telepon, email, kecamatan, paket, pilih_bayar,tanggal_upload) VALUES ('.$nik.','$nama','$alamat','$tempat_lahir','$tanggal_lahir','$jk','$nama_ayah','$nama_ibu','.$telepon.','$email','$kecamatan','$paket','$pilih_bayar',now())";
    $result = mysqli_query($conn, $simpan);

    if ($result) {
        echo "
        <script>
            alert('Data Telah Dikirim!');window.location='daftar_digital_market.php'
        </script>
        ";
    }
}
